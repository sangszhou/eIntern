    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://getbootstrap.com/examples/starter-template/#">Ruler</a>
        </div>
        <div class="collapse navbar-collapse">
          ...
          <li class="dropdown">
            <a id = "alogout" href="http://10.249.65.27:8080/Ruler/Logout">Log out <strong class="caret"></strong></a>
		...
		<div class="modal fade bs-example-modal-lg" id="myModal" tabindex="-1" role="dialog" 
		   ...
		   <div class="modal-dialog modal-lg">
		      <div class="modal-content">
		         ...
		         <div id = "ruledetails" class="modal-body">
		            Rule details
		         </div>
		         <div class="modal-footer">
		            ...
		            <button type="button" class="btn btn-primary"  data-dismiss="modal" id="btnconfirm">
		               confirm
		            </button>
		         </div>
		      </div><!-- /.modal-content -->
